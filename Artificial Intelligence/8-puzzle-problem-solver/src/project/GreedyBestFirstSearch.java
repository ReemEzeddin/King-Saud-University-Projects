...
//	final static String GOAL_STATE="12345670";
//	/**
...
//	 * of the queue.
//	 */
//	private LinkedList<Node> openStates = new LinkedList<Node>(); // Could use priority queue
//	
//	/**
...
//	 */
//	public ArrayList<String> findSolution(String startState, String goalState,Heuristic heuristic)
//	{
...
//		openStates.offer( new Node( startState, H_1 ) );
...
//			
//			// =========================================== Debug
//			System.out.println( "Current = " + nodeCounter + "  - h(current) = " + currentState.getTotalCost());
//			currentState.toString();
//			// =========================================== Debug
//
//			// If currentState == goalState, break and record path
//			if ( currentState.equalTo( new Node(GOAL_STATE) ))
//			{
//				solutionFound = true;
//				break;
//			}
