...
long enfTime= System.nanoTime();
        ...
        System.out.println("** Total Time for this solution: " + (enfTime-startTime));
    ...
    public int compareTo(Node o) {
        ...
        return 0;
            ...
            public boolean equals(Node n){
                ...
                if(this == null|| n.equals(null)) return false;
                return this.getState().equals(n.getState());
            }
    

    boolean equalTo(Node node) {
